...
void nRF24L01P::enableAutoAcknowledge(int pipe) {
	...
	if ((pipe < NRF24L01P_PIPE_P0) || (pipe > NRF24L01P_PIPE_P5)) { 	//check pipe is within limit 0 <= pipe <= 5
...
void nRF24L01P::setRfFrequency(int frequency) {
	...
	if ((frequency < NRF24L01P_MIN_RF_FREQUENCY) || (frequency > NRF24L01P_MAX_RF_FREQUENCY)) {	//check valid RFFrequency
